...
/**
 * Classe abstraite {@code ChangeView} permettant de construire un affichage bloquant la vue à l'adversaire tant que le joueur n'a pas décidé de changer de joueur.
 * 
 ...
 */
public abstract class ChangeView extends View{
    protected Scene s;
    protected static final String TITLE = "Changement tour joueur";
    ...
    public void start(){
        ...
        Label titleForScene = new Label(ChangeView.TITLE);
